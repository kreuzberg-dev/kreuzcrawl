...
```typescript
function batchScrape(engine: CrawlEngineHandle, urls: Array<string>): Promise<string>
```
...
```typescript
function batchCrawl(engine: CrawlEngineHandle, urls: Array<string>): Promise<string>
```
