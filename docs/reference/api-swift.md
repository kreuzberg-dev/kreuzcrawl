...
```swift
public static func batchScrape(engine: CrawlEngineHandle, urls: [String]) throws -> String
```
...
```swift
public static func batchCrawl(engine: CrawlEngineHandle, urls: [String]) throws -> String
```
