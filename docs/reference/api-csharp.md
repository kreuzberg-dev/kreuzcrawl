...
```csharp
public static async Task<string> BatchScrapeAsync(CrawlEngineHandle engine, List<string> urls)
```
...
```csharp
public static async Task<string> BatchCrawlAsync(CrawlEngineHandle engine, List<string> urls)
```
