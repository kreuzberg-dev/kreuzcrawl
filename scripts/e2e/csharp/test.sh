...
# CRAWLBERG_ALLOW_PRIVATE_NETWORK is set at the task level (csharp:e2e:test)
...
export CRAWLBERG_ALLOW_PRIVATE_NETWORK="${CRAWLBERG_ALLOW_PRIVATE_NETWORK:-true}"

dotnet test Crawlberg.E2eTests.csproj \
  -c Release \
