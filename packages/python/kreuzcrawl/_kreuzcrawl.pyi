...
# alef:hash:8e9c20a1ebdfc73f5ba531029ea808da6f7ef95b881089c40b342e5fbd5037cc
...
class CrawlEngineHandle:
    async def crawl_stream(self, req: CrawlStreamRequest) -> str: ...
    async def batch_crawl_stream(self, req: BatchCrawlStreamRequest) -> str: ...
