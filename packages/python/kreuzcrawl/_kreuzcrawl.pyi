...
class InteractionResult:
    ...
    def __init__(
        self, action_results: list[ActionResult], final_html: str, final_url: str, screenshot: bytes | None = None
    ) -> None: ...
...
class SitemapUrl:
    ...
    priority: str | None
    def __init__(
        self, url: str, lastmod: str | None = None, changefreq: str | None = None, priority: str | None = None
    ) -> None: ...
...
class ImageInfo:
    ...
    source: ImageSource
    def __init__(
        self, url: str, source: str, alt: str | None = None, width: int | None = None, height: int | None = None
    ) -> None: ...
