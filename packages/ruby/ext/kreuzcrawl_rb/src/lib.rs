...
impl ActionResult {
    fn new(action_index: usize, action_type: String, success: bool, data: Option<String>, error: Option<String>) -> Self {
            Self { action_index, action_type, success, data, error }
        }
...
impl CachedPage {
    fn new(
            ...
            Self { url, status_code, content_type, body, etag, last_modified, cached_at }
        }
...
impl CitationReference {
    fn new(index: usize, url: String, text: String) -> Self {
            Self { index, url, text }
        }
...
impl BatchScrapeResult {
    fn new(url: String, result: Option<ScrapeResult>, error: Option<String>) -> Self {
...
impl BatchCrawlResult {
    fn new(url: String, result: Option<CrawlResult>, error: Option<String>) -> Self {
            Self { url, result, error }
        }
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_singleton_method("new", function!(CrawlResult::new, 6))?;
