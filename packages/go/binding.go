...
// alef:hash:aa792a1c2a3b33aaf7ff456fac5cf126c02d155d1f1e4d78d6ca51a511e54ebb
...
func CrawlStream(engine *CrawlEngineHandle, req CrawlStreamRequest) (<-chan CrawlEvent, error) {
	return engine.CrawlStream(req)
}

// BatchCrawlStream wraps the CrawlEngineHandle.BatchCrawlStream streaming adapter,
// exposing it as a module-level function for test and consumer convenience.
func BatchCrawlStream(engine *CrawlEngineHandle, req BatchCrawlStreamRequest) (<-chan CrawlEvent, error) {
