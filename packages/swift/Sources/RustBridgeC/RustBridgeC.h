...
void* __swift_bridge__$CrawlResult$new(void* pages, void* final_url, uintptr_t redirect_count, bool was_skipped, void* error, void* cookies, bool stayed_on_domain);
