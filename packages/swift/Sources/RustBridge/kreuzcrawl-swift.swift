...
extension CrawlConfigRef {
    ...
    public func auth() -> Optional<AuthConfig> {
        { let val = __swift_bridge__$CrawlConfig$auth(ptr); if val != nil { return AuthConfig(ptr: val!) } else { return nil } }()
    }
...
extension ScrapeResultRef {
    ...
    public func screenshot() -> Optional<RustVec<UInt8>> {
        { let val = __swift_bridge__$ScrapeResult$screenshot(ptr); if val != nil { return RustVec(ptr: val!) } else { return nil } }()
    }
