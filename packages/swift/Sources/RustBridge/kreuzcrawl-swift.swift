...
public func batchScrape<GenericIntoRustString: IntoRustString>(
  ...
  try {
    ...
    if val.is_ok {
      return BatchScrapeResults(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func batchCrawl<GenericIntoRustString: IntoRustString>(
  ...
  try {
    ...
    if val.is_ok {
      return BatchCrawlResults(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func crawlEngineHandleCrawlStreamStart(
  _ client: CrawlEngineHandleRef, _ req: CrawlStreamRequestRef
) throws -> CrawlEngineHandleCrawlStreamStreamHandle {
  try {
    let val = __swift_bridge__$crawl_engine_handle_crawl_stream_start(client.ptr, req.ptr)
    if val.is_ok {
      return CrawlEngineHandleCrawlStreamStreamHandle(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func crawlEngineHandleBatchCrawlStreamStart(
  _ client: CrawlEngineHandleRef, _ req: BatchCrawlStreamRequestRef
) throws -> CrawlEngineHandleBatchCrawlStreamStreamHandle {
  try {
    let val = __swift_bridge__$crawl_engine_handle_batch_crawl_stream_start(client.ptr, req.ptr)
    if val.is_ok {
      return CrawlEngineHandleBatchCrawlStreamStreamHandle(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func crawlStreamRequestFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> CrawlStreamRequest {
  try {
    let val = __swift_bridge__$crawl_stream_request_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CrawlStreamRequest(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func batchCrawlStreamRequestFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BatchCrawlStreamRequest {
  try {
    let val = __swift_bridge__$batch_crawl_stream_request_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BatchCrawlStreamRequest(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func extractionMetaFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ExtractionMeta {
  try {
    let val = __swift_bridge__$extraction_meta_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ExtractionMeta(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func proxyConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ProxyConfig {
  try {
    let val = __swift_bridge__$proxy_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ProxyConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func contentConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ContentConfig {
  try {
    let val = __swift_bridge__$content_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ContentConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func browserConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BrowserConfig {
  try {
    let val = __swift_bridge__$browser_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BrowserConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func browserExtrasFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BrowserExtras {
  try {
    let val = __swift_bridge__$browser_extras_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BrowserExtras(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func downloadedDocumentFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> DownloadedDocument {
  try {
    let val = __swift_bridge__$downloaded_document_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DownloadedDocument(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func interactionResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> InteractionResult {
  try {
    let val = __swift_bridge__$interaction_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func actionResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ActionResult {
  try {
    let val = __swift_bridge__$action_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ActionResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func scrapeResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ScrapeResult {
  try {
    let val = __swift_bridge__$scrape_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func crawlPageResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> CrawlPageResult {
  try {
    let val = __swift_bridge__$crawl_page_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CrawlPageResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func crawlResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> CrawlResult {
  try {
    let val = __swift_bridge__$crawl_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func sitemapUrlFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> SitemapUrl
{
  try {
    let val = __swift_bridge__$sitemap_url_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return SitemapUrl(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func mapResultFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> MapResult
{
  try {
    let val = __swift_bridge__$map_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func markdownResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> MarkdownResult {
  try {
    let val = __swift_bridge__$markdown_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return MarkdownResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func linkInfoFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> LinkInfo
{
  try {
    let val = __swift_bridge__$link_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return LinkInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func imageInfoFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> ImageInfo
{
  try {
    let val = __swift_bridge__$image_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ImageInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func feedInfoFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> FeedInfo
{
  try {
    let val = __swift_bridge__$feed_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return FeedInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func jsonLdEntryFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> JsonLdEntry {
  try {
    let val = __swift_bridge__$json_ld_entry_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return JsonLdEntry(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func cookieInfoFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> CookieInfo
{
  try {
    let val = __swift_bridge__$cookie_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CookieInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func downloadedAssetFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> DownloadedAsset {
  try {
    let val = __swift_bridge__$downloaded_asset_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DownloadedAsset(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func articleMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ArticleMetadata {
  try {
    let val = __swift_bridge__$article_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ArticleMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func hreflangEntryFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> HreflangEntry {
  try {
    let val = __swift_bridge__$hreflang_entry_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return HreflangEntry(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func faviconInfoFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> FaviconInfo {
  try {
    let val = __swift_bridge__$favicon_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return FaviconInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func headingInfoFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> HeadingInfo {
  try {
    let val = __swift_bridge__$heading_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return HeadingInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func responseMetaFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ResponseMeta {
  try {
    let val = __swift_bridge__$response_meta_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ResponseMeta(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pageMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PageMetadata {
  try {
    let val = __swift_bridge__$page_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PageMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func citationResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> CitationResult {
  try {
    let val = __swift_bridge__$citation_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CitationResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func citationReferenceFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> CitationReference {
  try {
    let val = __swift_bridge__$citation_reference_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CitationReference(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func batchScrapeResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BatchScrapeResult {
  try {
    let val = __swift_bridge__$batch_scrape_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BatchScrapeResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func batchCrawlResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BatchCrawlResult {
  try {
    let val = __swift_bridge__$batch_crawl_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BatchCrawlResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func batchScrapeResultsFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BatchScrapeResults {
  try {
    let val = __swift_bridge__$batch_scrape_results_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func batchCrawlResultsFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BatchCrawlResults {
  try {
    let val = __swift_bridge__$batch_crawl_results_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
...
public func browserModeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BrowserMode {
  try {
    let val = __swift_bridge__$browser_mode_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BrowserMode(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func browserWaitFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BrowserWait {
  try {
    let val = __swift_bridge__$browser_wait_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BrowserWait(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func browserBackendFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BrowserBackend {
  try {
    let val = __swift_bridge__$browser_backend_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BrowserBackend(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func authConfigFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> AuthConfig
{
  try {
    let val = __swift_bridge__$auth_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return AuthConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func imageSourceFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ImageSource {
  try {
    let val = __swift_bridge__$image_source_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ImageSource(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func feedTypeFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> FeedType
{
  try {
    let val = __swift_bridge__$feed_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return FeedType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func assetCategoryFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> AssetCategory {
  try {
    let val = __swift_bridge__$asset_category_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return AssetCategory(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func crawlEventFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> CrawlEvent
{
  try {
    let val = __swift_bridge__$crawl_event_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CrawlEvent(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pageActionFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> PageAction
{
  try {
    let val = __swift_bridge__$page_action_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PageAction(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func scrollDirectionFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ScrollDirection {
  try {
    let val = __swift_bridge__$scroll_direction_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ScrollDirection(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
  ...
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    self.init(
      ptr: __swift_bridge__$BrowserConfig$new(
        ...
        }(), capture_network_events, session_affinity))
  }
}
...
extension BrowserConfigRef {
  ...
  public func waitSelector() -> RustString? {
    {
  ...
  public func evalScript() -> RustString? {
    {
  ...
  public func robotsUserAgent() -> RustString? {
    {
...
extension CrawlConfigRef {
  ...
  public func userAgent() -> RustString? {
    {
  ...
  public func rateLimitMs() -> UInt64? {
  ...
  public func mapLimit() -> UInt? {
    __swift_bridge__$CrawlConfig$map_limit(ptr).intoSwiftRepr()
  }

  public func mapSearch() -> RustString? {
    {
  ...
  public func documentMaxSize() -> UInt? {
  ...
  public func warcOutput() -> RustString? {
    {
  ...
  public func browserProfile() -> RustString? {
    {
...
extension BrowserExtrasRef {
  public func evalResult() -> RustString? {
    {
...
extension ScrapeResult {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ status_code: UInt16, _ final_url: GenericIntoRustString,
    ...
    _ feeds: RustVec<FeedInfo>, _ json_ld: RustVec<JsonLdEntry>, _ is_allowed: Bool,
    _ crawl_delay: UInt64?, _ noindex_detected: Bool, _ nofollow_detected: Bool,
...
extension ScrapeResultRef {
  ...
  public func xRobotsTag() -> RustString? {
    {
  ...
  public func detectedCharset() -> RustString? {
    {
  ...
  public func responseMeta() -> ResponseMeta? {
    {
  ...
  public func extractedData() -> RustString? {
    {
  ...
  public func extractionMeta() -> ExtractionMeta? {
    {
  ...
  public func downloadedDocument() -> DownloadedDocument? {
    {
...
extension CrawlPageResult {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ downloaded_document: DownloadedDocument?, _ browser_used: Bool
  ) {
    self.init(
...
extension CrawlResult {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ stayed_on_domain: Bool, _ browser_used: Bool
  ) {
    self.init(
...
extension MarkdownResult {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ citations: Bool, _ fit_content: GenericIntoRustString?
  ) {
    self.init(
...
extension MarkdownResultRef {
  ...
  public func documentStructure() -> RustString? {
    {
  ...
  public func fitContent() -> RustString? {
    {
...
extension DownloadedAssetRef {
  ...
  public func htmlTag() -> RustString? {
    {
...
extension ArticleMetadataRef {
  public func publishedTime() -> RustString? {
    {
  ...
  public func modifiedTime() -> RustString? {
    {
...
extension ResponseMetaRef {
  ...
  public func lastModified() -> RustString? {
    {
  ...
  public func xPoweredBy() -> RustString? {
    {
  ...
  public func contentLanguage() -> RustString? {
    {
...
extension PageMetadataRef {
  ...
  public func themeColor() -> RustString? {
    {
  ...
  public func htmlLang() -> RustString? {
    {
  ...
  public func htmlDir() -> RustString? {
    {
  ...
  public func ogTitle() -> RustString? {
    {
  ...
  public func ogImage() -> RustString? {
    {
  ...
  public func ogDescription() -> RustString? {
    {
  ...
  public func ogSiteName() -> RustString? {
    {
  ...
  public func ogLocale() -> RustString? {
    {
  ...
  public func ogVideo() -> RustString? {
    {
  ...
  public func ogAudio() -> RustString? {
    {
  ...
  public func ogLocaleAlternates() -> RustVec<RustString>? {
    {
  ...
  public func twitterTitle() -> RustString? {
    {
  ...
  public func twitterDescription() -> RustString? {
    {
  ...
  public func twitterImage() -> RustString? {
    {
  ...
  public func twitterSite() -> RustString? {
    {
  ...
  public func twitterCreator() -> RustString? {
    {
  ...
  public func dcTitle() -> RustString? {
    {
  ...
  public func dcCreator() -> RustString? {
    {
  ...
  public func dcSubject() -> RustString? {
    {
  ...
  public func dcDescription() -> RustString? {
    {
  ...
  public func dcPublisher() -> RustString? {
    {
  ...
  public func dcIdentifier() -> RustString? {
    {
  ...
  public func dcLanguage() -> RustString? {
    {
  ...
  public func dcRights() -> RustString? {
    {
...
extension CrawlStreamRequest {
  public convenience init<GenericIntoRustString: IntoRustString>(_ url: GenericIntoRustString) {
    self.init(
      ptr: __swift_bridge__$CrawlStreamRequest$new(
        {
          let rustString = url.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
...
extension CrawlStreamRequest: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: CrawlStreamRequest) {
    __swift_bridge__$Vec_CrawlStreamRequest$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    CrawlStreamRequestRef
  > {
    UnsafePointer<CrawlStreamRequestRef>(
      OpaquePointer(__swift_bridge__$Vec_CrawlStreamRequest$as_ptr(vecPtr)))
  }
...
extension BatchCrawlStreamRequest {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ urls: RustVec<GenericIntoRustString>
  ) {
    self.init(
      ptr: __swift_bridge__$BatchCrawlStreamRequest$new(
        {
          let val = urls
          val.isOwned = false
          return val.ptr
...
extension BatchCrawlStreamRequest: Vectorizable {
  ...
  {
    __swift_bridge__$Vec_BatchCrawlStreamRequest$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    BatchCrawlStreamRequestRef
  > {
    UnsafePointer<BatchCrawlStreamRequestRef>(
      OpaquePointer(__swift_bridge__$Vec_BatchCrawlStreamRequest$as_ptr(vecPtr)))
  }
...
extension BatchScrapeResults {
  public convenience init(
    _ results: RustVec<BatchScrapeResult>, _ total_count: UInt, _ completed_count: UInt,
    _ failed_count: UInt
  ) {
    self.init(
      ptr: __swift_bridge__$BatchScrapeResults$new(
        {
          let val = results
          val.isOwned = false
          return val.ptr
...
extension BatchScrapeResults: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: BatchScrapeResults) {
    __swift_bridge__$Vec_BatchScrapeResults$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    BatchScrapeResultsRef
  > {
    UnsafePointer<BatchScrapeResultsRef>(
      OpaquePointer(__swift_bridge__$Vec_BatchScrapeResults$as_ptr(vecPtr)))
  }
...
extension BatchCrawlResults {
  public convenience init(
    _ results: RustVec<BatchCrawlResult>, _ total_count: UInt, _ completed_count: UInt,
    _ failed_count: UInt
  ) {
    self.init(
      ptr: __swift_bridge__$BatchCrawlResults$new(
        {
          let val = results
          val.isOwned = false
          return val.ptr
...
extension BatchCrawlResults: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: BatchCrawlResults) {
    __swift_bridge__$Vec_BatchCrawlResults$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    BatchCrawlResultsRef
  > {
    UnsafePointer<BatchCrawlResultsRef>(
      OpaquePointer(__swift_bridge__$Vec_BatchCrawlResults$as_ptr(vecPtr)))
  }
...
extension CrawlEvent: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: CrawlEvent) {
    __swift_bridge__$Vec_CrawlEvent$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> CrawlEventRef? {
...
public class CrawlEngineHandleBatchCrawlStreamStreamHandle:
  CrawlEngineHandleBatchCrawlStreamStreamHandleRefMut
{
  var isOwned: Bool = true
...
public class CrawlEngineHandleBatchCrawlStreamStreamHandleRefMut:
  CrawlEngineHandleBatchCrawlStreamStreamHandleRef
{
  public override init(ptr: UnsafeMutableRawPointer) {
    super.init(ptr: ptr)
  }
...
extension CrawlEngineHandleBatchCrawlStreamStreamHandleRefMut {
  public func next() throws -> RustString {
    try {
      let val = __swift_bridge__$CrawlEngineHandleBatchCrawlStreamStreamHandle$next(ptr)
      if val.is_ok {
...
extension CrawlEngineHandleBatchCrawlStreamStreamHandle: Vectorizable {
  ...
  public static func vecOfSelfPush(
    vecPtr: UnsafeMutableRawPointer, value: CrawlEngineHandleBatchCrawlStreamStreamHandle
  ) {
    __swift_bridge__$Vec_CrawlEngineHandleBatchCrawlStreamStreamHandle$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt)
    -> CrawlEngineHandleBatchCrawlStreamStreamHandleRef?
  {
    let pointer = __swift_bridge__$Vec_CrawlEngineHandleBatchCrawlStreamStreamHandle$get(
      vecPtr, index)
    if pointer == nil {
      return nil
    } else {
  ...
  public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt)
    -> CrawlEngineHandleBatchCrawlStreamStreamHandleRefMut?
  {
    let pointer = __swift_bridge__$Vec_CrawlEngineHandleBatchCrawlStreamStreamHandle$get_mut(
      vecPtr, index)
    if pointer == nil {
      return nil
    } else {
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    CrawlEngineHandleBatchCrawlStreamStreamHandleRef
  > {
    UnsafePointer<CrawlEngineHandleBatchCrawlStreamStreamHandleRef>(
      OpaquePointer(
        __swift_bridge__$Vec_CrawlEngineHandleBatchCrawlStreamStreamHandle$as_ptr(vecPtr)))
  }
...
public class CrawlEngineHandleCrawlStreamStreamHandle:
  CrawlEngineHandleCrawlStreamStreamHandleRefMut
{
  var isOwned: Bool = true
...
public class CrawlEngineHandleCrawlStreamStreamHandleRefMut:
  CrawlEngineHandleCrawlStreamStreamHandleRef
{
  public override init(ptr: UnsafeMutableRawPointer) {
    super.init(ptr: ptr)
  }
...
extension CrawlEngineHandleCrawlStreamStreamHandleRefMut {
  public func next() throws -> RustString {
    try {
      let val = __swift_bridge__$CrawlEngineHandleCrawlStreamStreamHandle$next(ptr)
      if val.is_ok {
        return RustString(ptr: val.ok_or_err!)
      } else {
        throw RustString(ptr: val.ok_or_err!)
...
extension CrawlEngineHandleCrawlStreamStreamHandle: Vectorizable {
  ...
  public static func vecOfSelfPush(
    vecPtr: UnsafeMutableRawPointer, value: CrawlEngineHandleCrawlStreamStreamHandle
  ) {
    __swift_bridge__$Vec_CrawlEngineHandleCrawlStreamStreamHandle$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt)
    -> CrawlEngineHandleCrawlStreamStreamHandleRefMut?
  {
    let pointer = __swift_bridge__$Vec_CrawlEngineHandleCrawlStreamStreamHandle$get_mut(
      vecPtr, index)
    if pointer == nil {
      return nil
    } else {
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    CrawlEngineHandleCrawlStreamStreamHandleRef
  > {
    UnsafePointer<CrawlEngineHandleCrawlStreamStreamHandleRef>(
      OpaquePointer(__swift_bridge__$Vec_CrawlEngineHandleCrawlStreamStreamHandle$as_ptr(vecPtr)))
  }
