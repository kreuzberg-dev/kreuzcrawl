...
public record ResponseMeta(Optional<String> etag, @JsonProperty("last_modified") Optional<String> lastModified,
		@JsonProperty("cache_control") Optional<String> cacheControl, Optional<String> server,
