...
// alef:hash:92d1726dba9f792e20684f58e42c43500d3eba42e8f110765a935801c14bd0e5
...
public class CrawlConfigBuilder {
	...
	public CrawlConfig build() {
		return new CrawlConfig(maxDepth.orElse(null), maxPages.orElse(null), maxConcurrent.orElse(null),
				respectRobotsTxt, softHttpErrors, userAgent.orElse(null), stayOnDomain, allowSubdomains, includePaths,
				excludePaths, customHeaders, requestTimeout, rateLimitMs.orElse(null), maxRedirects, retryCount,
				retryCodes, cookiesEnabled, auth.orElse(null), maxBodySize.orElse(null), removeTags, content,
				mapLimit.orElse(null), mapSearch.orElse(null), downloadAssets, assetTypes, maxAssetSize.orElse(null),
				browser, proxy.orElse(null), userAgents, captureScreenshot, downloadDocuments,
				documentMaxSize.orElse(null), documentMimeTypes, warcOutput.orElse(null), browserProfile.orElse(null),
				saveBrowserProfile);
	}
}
