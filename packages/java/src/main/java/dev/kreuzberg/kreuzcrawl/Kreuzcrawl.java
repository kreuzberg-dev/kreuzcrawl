...
// alef:hash:349bbf66d5ed8a3c7b65309ac2530352ed5c78679e44f32796ae1138a15a89cb
...
public final class Kreuzcrawl {
    ...
    public static java.util.Iterator<CrawlEvent> crawlStream(CrawlStreamRequest req) throws KreuzcrawlRsException {
        return KreuzcrawlRs.crawlStream(req);
    }

    public static java.util.Iterator<CrawlEvent> batchCrawlStream(BatchCrawlStreamRequest req) throws KreuzcrawlRsException {
        return KreuzcrawlRs.batchCrawlStream(req);
    }
}
