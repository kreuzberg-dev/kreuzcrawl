...
// alef:hash:eee876e5b8e46295c7f0ced0cabea48ec1cd21e4756affc40f19dceed4dd9b08
...
public final class KreuzcrawlRs {
    ...
    public static BatchScrapeResults batchScrape(final CrawlEngineHandle engine, final List<String> urls) throws KreuzcrawlRsException {
        try (var arena = Arena.ofShared()) {
            ...
            String json = jsonPtr.reinterpret(Long.MAX_VALUE).getString(0);
            NativeLib.KCRAWL_FREE_STRING.invoke(jsonPtr);
            System.err.println("[DEBUG] batchScrape JSON: " + json);
            var result = MAPPER.readValue(json, BatchScrapeResults.class);
            System.err.println("[DEBUG] batchScrape result: completed=" + result.completedCount() + ", results=" + result.results());
            return result;
            // CPD-ON
        } catch (Throwable e) {
            throw new KreuzcrawlRsException("FFI call failed", e);
