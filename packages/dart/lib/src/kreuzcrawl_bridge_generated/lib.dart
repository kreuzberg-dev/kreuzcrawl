...
final bool sessionAffinity;
                ...
                const BrowserConfig({required this.mode ,required this.backend ,this.endpoint ,required this.timeout ,required this.wait ,this.waitSelector ,this.extraWait ,required this.stealth ,this.proxy ,required this.blockUrlPatterns ,this.evalScript ,this.robotsUserAgent ,required this.captureNetworkEvents ,required this.sessionAffinity ,});
        ...
        @override
        int get hashCode => mode.hashCode^backend.hashCode^endpoint.hashCode^timeout.hashCode^wait.hashCode^waitSelector.hashCode^extraWait.hashCode^stealth.hashCode^proxy.hashCode^blockUrlPatterns.hashCode^evalScript.hashCode^robotsUserAgent.hashCode^captureNetworkEvents.hashCode^sessionAffinity.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is BrowserConfig &&
                runtimeType == other.runtimeType
                && mode == other.mode&& backend == other.backend&& endpoint == other.endpoint&& timeout == other.timeout&& wait == other.wait&& waitSelector == other.waitSelector&& extraWait == other.extraWait&& stealth == other.stealth&& proxy == other.proxy&& blockUrlPatterns == other.blockUrlPatterns&& evalScript == other.evalScript&& robotsUserAgent == other.robotsUserAgent&& captureNetworkEvents == other.captureNetworkEvents&& sessionAffinity == other.sessionAffinity;
