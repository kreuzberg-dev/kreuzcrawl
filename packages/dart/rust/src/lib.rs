...
impl From<kreuzcrawl::AuthConfig> for AuthConfig {
    fn from(v: kreuzcrawl::AuthConfig) -> Self {
        match v {
            kreuzcrawl::AuthConfig::Basic { username, password } => AuthConfig::Basic {
                username: username.into(),
                password: password.into(),
            },
            kreuzcrawl::AuthConfig::Bearer { token } => AuthConfig::Bearer { token: token.into() },
            kreuzcrawl::AuthConfig::Header { name, value } => AuthConfig::Header {
                name: name.into(),
                value: value.into(),
            },
        }
...
impl From<AuthConfig> for kreuzcrawl::AuthConfig {
    fn from(v: AuthConfig) -> Self {
        match v {
            AuthConfig::Basic { username, password } => kreuzcrawl::AuthConfig::Basic {
                username: username.into(),
                password: password.into(),
            },
            AuthConfig::Bearer { token } => kreuzcrawl::AuthConfig::Bearer { token: token.into() },
            AuthConfig::Header { name, value } => kreuzcrawl::AuthConfig::Header {
                name: name.into(),
                value: value.into(),
            },
        }
