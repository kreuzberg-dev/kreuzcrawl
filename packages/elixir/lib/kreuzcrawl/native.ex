...
# alef:hash:4845859e4e5214339ea50529c5152eaa416d85e524fd8bb4ffca0cb501c7493e
...
defmodule Kreuzcrawl.Native do
  ...
  use RustlerPrecompiled,
    ...
    force_build:
      System.get_env("KREUZCRAWL_BUILD") in ["1", "true"] or
        Application.compile_env(:rustler_precompiled, [:force_build, :kreuzcrawl], false) or
        Mix.env() in [:test, :dev],
    targets:
