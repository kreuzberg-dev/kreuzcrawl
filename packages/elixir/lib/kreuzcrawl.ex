...
# alef:hash:a1bdea2ea6f0c04c21a9e6d67c3aad44ff4334ba70512dd27b44250282cbba5e
...
defmodule Kreuzcrawl do
  ...
  @spec create_engine(keyword()) :: {:ok, reference()} | {:error, String.t()}
  def create_engine(opts \\ []) do
    Kreuzcrawl.Native.create_engine(Keyword.get(opts, :config))
  end
