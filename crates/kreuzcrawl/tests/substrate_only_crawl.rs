...
//!
//! Additionally, the public substrate parsers (`kreuzcrawl::robots::*`,
//! `kreuzcrawl::sitemap::*`) are exercised directly to confirm they are
//! reachable from out-of-crate code without spinning the engine.

use kreuzcrawl::robots::{is_path_allowed, parse_robots_txt};
use kreuzcrawl::sitemap::{is_sitemap_index, parse_sitemap_xml};
...
fn substrate_robots_parser_is_reachable_out_of_crate() {
    let rules = parse_robots_txt(ROBOTS_BODY, "kreuzcrawl");
