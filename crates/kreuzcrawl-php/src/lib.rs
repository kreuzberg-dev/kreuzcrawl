...
// alef:hash:5fb57cc0b950eb1a5b278d12156c5daf0828fc0c1f42959aca9545b5203a3368
...
impl BrowserExtras {
    ...
    #[php(getter)]
    pub fn get_evalResult(&self) -> Option<String> {
        self.eval_result.as_ref().and_then(|v| serde_json::to_string(v).ok())
    }

    #[php(getter)]
    pub fn get_networkEvents(&self) -> Vec<ResponseMeta> {
