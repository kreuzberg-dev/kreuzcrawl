...
// alef:hash:084dae8528a6360f025939411531dae7246edfe1350d16985eef6ffe1d97f17b
...
impl CrawlEngineHandle {
     ...
     */
    pub fn crawl_stream(&self, req: &CrawlStreamRequest) -> PhpResult<String> {
        ...
        WORKER_RUNTIME.block_on(async {
            let stream = self
                ...
                .await
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            let chunks: Vec<CrawlEvent> = stream
                .collect::<Vec<_>>()
                .await
                .into_iter()
                .collect::<std::result::Result<Vec<_>, _>>()
                .map(|v| v.into_iter().map(CrawlEvent::from).collect())
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
     ...
     */
    pub fn batch_crawl_stream(&self, req: &BatchCrawlStreamRequest) -> PhpResult<String> {
        use futures_util::StreamExt;
