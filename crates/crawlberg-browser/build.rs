...
fn main() {
    ...
    let snapshot_path = out_dir.join("crawlberg_browser_snapshot.bin");
    ...
    let output = deno_core::snapshot::create_snapshot(
        deno_core::snapshot::CreateSnapshotOptions {
            ...
            with_runtime_cb: Some(Box::new(move |runtime| {
                runtime
                    .execute_script("<crawlberg:bootstrap>", bootstrap_js.to_string())
    ...
    println!(
        "cargo:rustc-env=CRAWLBERG_BROWSER_SNAPSHOT_PATH={}",
