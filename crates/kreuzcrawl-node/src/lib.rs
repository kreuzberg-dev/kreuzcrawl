...
// alef:hash:3b7d22724425506e5315d4e9f43d6ef0dd54c428c6e1df929a64cf890929448a
...
pub async fn crawl_stream(engine: &JsCrawlEngineHandle, url: String) -> Result<CrawlStreamIterator> {
    let core_CrawlStreamRequest: kreuzcrawl::CrawlStreamRequest = JsCrawlStreamRequest { url: Some(url) }.into();
...
pub async fn batch_crawl_stream(engine: &JsCrawlEngineHandle, urls: Vec<String>) -> Result<BatchCrawlStreamIterator> {
    let core_BatchCrawlStreamRequest: kreuzcrawl::BatchCrawlStreamRequest =
