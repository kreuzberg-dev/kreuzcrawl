...
// alef:hash:140d73a22dd666578ac1e5318bab6bbf3c31f7c838cb2d205154b74952c2ee05
...
impl JsCrawlEngineHandle {
    ...
    pub async fn crawl_stream(&self, req: JsCrawlStreamRequest) -> Result<Vec<JsCrawlEvent>> {
        ...
        let chunks: Vec<JsCrawlEvent> = stream
            .collect::<Vec<_>>()
            .await
            .into_iter()
            .collect::<std::result::Result<Vec<_>, _>>()
            .map(|v| v.into_iter().map(JsCrawlEvent::from).collect())
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        Ok(chunks)
    }
    ...
    pub async fn batch_crawl_stream(&self, req: JsBatchCrawlStreamRequest) -> Result<Vec<JsCrawlEvent>> {
        use futures_util::StreamExt;
...
#[napi(string_enum, js_name = "CrawlEvent")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
