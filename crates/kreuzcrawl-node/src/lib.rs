...
// alef:hash:8b01dcbc3982459b36d107d588133d49c432a5f93d0d876e26e975d2b9e34614
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "crawlStream")]
pub async fn crawl_stream(engine: &JsCrawlEngineHandle, req: JsCrawlStreamRequest) -> Result<JsCrawlEventIterator> {
    let core_req: kreuzcrawl::CrawlStreamRequest = req.into();
