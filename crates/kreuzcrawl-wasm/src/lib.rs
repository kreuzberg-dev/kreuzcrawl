...
impl JsExtractionMeta {
    ...
    pub fn new(
        ...
        JsExtractionMeta { cost: cost, prompt_tokens: prompt_tokens, completion_tokens: completion_tokens, model: model, chunks_processed: chunks_processed.unwrap_or_default() }
    }
...
impl JsProxyConfig {
    ...
    pub fn new(url: Option<String>, username: Option<String>, password: Option<String>) -> JsProxyConfig {
        JsProxyConfig { url: url.unwrap_or_default(), username: username, password: password }
    }
...
impl JsBrowserConfig {
    ...
    pub fn new(
        ...
        JsBrowserConfig { mode: mode.unwrap_or_default(), endpoint: endpoint, timeout: timeout.unwrap_or_default(), wait: wait.unwrap_or_default(), wait_selector: wait_selector, extra_wait: extra_wait }
    }
...
impl JsCrawlConfig {
    ...
    pub fn new(
        ...
        JsCrawlConfig { max_depth: max_depth, max_pages: max_pages, max_concurrent: max_concurrent, respect_robots_txt: respect_robots_txt.unwrap_or_else(|| false), user_agent: user_agent, stay_on_domain: stay_on_domain.unwrap_or_else(|| false), allow_subdomains: allow_subdomains.unwrap_or_else(|| false), include_paths: include_paths.unwrap_or_default(), exclude_paths: exclude_paths.unwrap_or_default(), custom_headers: custom_headers.unwrap_or_default(), request_timeout: request_timeout.unwrap_or_default(), max_redirects: max_redirects.unwrap_or_else(|| 10), retry_count: retry_count.unwrap_or_else(|| 0), retry_codes: retry_codes.unwrap_or_default(), cookies_enabled: cookies_enabled.unwrap_or_else(|| false), auth: auth, max_body_size: max_body_size, main_content_only: main_content_only.unwrap_or_else(|| false), remove_tags: remove_tags.unwrap_or_default(), map_limit: map_limit, map_search: map_search, download_assets: download_assets.unwrap_or_else(|| false), asset_types: asset_types.unwrap_or_default(), max_asset_size: max_asset_size, browser: browser.unwrap_or_default(), proxy: proxy, user_agents: user_agents.unwrap_or_default(), capture_screenshot: capture_screenshot.unwrap_or_else(|| false), download_documents: download_documents.unwrap_or_else(|| true), document_max_size: document_max_size, document_mime_types: document_mime_types.unwrap_or_default(), warc_output: warc_output, browser_profile: browser_profile, save_browser_profile: save_browser_profile.unwrap_or_else(|| false) }
    }
...
impl JsDownloadedDocument {
    ...
    pub fn new(
        ...
        JsDownloadedDocument { url: url.unwrap_or_default(), mime_type: mime_type.unwrap_or_default(), content: content.unwrap_or_default(), size: size.unwrap_or_default(), filename: filename, content_hash: content_hash.unwrap_or_default(), headers: headers.unwrap_or_default() }
    }
...
impl JsInteractionResult {
    ...
    pub fn new(
        ...
        JsInteractionResult { action_results: action_results.unwrap_or_default(), final_html: final_html.unwrap_or_default(), final_url: final_url.unwrap_or_default(), screenshot: screenshot }
    }
...
impl JsActionResult {
    ...
    pub fn new(
        ...
        JsActionResult { action_index: action_index.unwrap_or_default(), action_type: action_type.unwrap_or_default(), success: success.unwrap_or_default(), data: data, error: error }
    }
...
impl JsCrawlResult {
    ...
    pub fn new(
        ...
        JsCrawlResult { pages: pages.unwrap_or_default(), final_url: final_url.unwrap_or_default(), redirect_count: redirect_count.unwrap_or_default(), was_skipped: was_skipped.unwrap_or_default(), error: error, cookies: cookies.unwrap_or_default(), normalized_urls: normalized_urls.unwrap_or_default() }
    }
...
impl JsSitemapUrl {
    #[wasm_bindgen(constructor)]
    pub fn new(url: Option<String>, lastmod: Option<String>, changefreq: Option<String>, priority: Option<String>) -> JsSitemapUrl {
        JsSitemapUrl { url: url.unwrap_or_default(), lastmod: lastmod, changefreq: changefreq, priority: priority }
    }
...
impl JsMapResult {
    ...
    pub fn new(urls: Option<Vec<JsSitemapUrl>>) -> JsMapResult {
        JsMapResult { urls: urls.unwrap_or_default() }
    }
...
impl JsMarkdownResult {
    ...
    pub fn new(
        ...
        JsMarkdownResult { content: content.unwrap_or_default(), document_structure: document_structure, tables: tables.unwrap_or_default(), warnings: warnings.unwrap_or_default(), citations: citations, fit_content: fit_content }
    }
...
impl JsCachedPage {
    ...
    pub fn new(
        ...
        JsCachedPage { url: url.unwrap_or_default(), status_code: status_code.unwrap_or_default(), content_type: content_type.unwrap_or_default(), body: body.unwrap_or_default(), etag: etag, last_modified: last_modified, cached_at: cached_at.unwrap_or_default() }
    }
...
impl JsLinkInfo {
    ...
    pub fn new(
        ...
        JsLinkInfo { url: url.unwrap_or_default(), text: text.unwrap_or_default(), link_type: link_type.unwrap_or_default(), rel: rel, nofollow: nofollow.unwrap_or_default() }
    }
...
impl JsImageInfo {
    ...
    pub fn new(
        ...
        JsImageInfo { url: url.unwrap_or_default(), alt: alt, width: width, height: height, source: source.unwrap_or_default() }
    }
...
impl JsFeedInfo {
    ...
    pub fn new(url: Option<String>, feed_type: Option<JsFeedType>, title: Option<String>) -> JsFeedInfo {
        JsFeedInfo { url: url.unwrap_or_default(), title: title, feed_type: feed_type.unwrap_or_default() }
    }
...
impl JsJsonLdEntry {
    ...
    pub fn new(schema_type: Option<String>, raw: Option<String>, name: Option<String>) -> JsJsonLdEntry {
        JsJsonLdEntry { schema_type: schema_type.unwrap_or_default(), name: name, raw: raw.unwrap_or_default() }
    }
...
impl JsCookieInfo {
    #[wasm_bindgen(constructor)]
    pub fn new(name: Option<String>, value: Option<String>, domain: Option<String>, path: Option<String>) -> JsCookieInfo {
        JsCookieInfo { name: name.unwrap_or_default(), value: value.unwrap_or_default(), domain: domain, path: path }
    }
...
impl JsDownloadedAsset {
    ...
    pub fn new(
        ...
        JsDownloadedAsset { url: url.unwrap_or_default(), content_hash: content_hash.unwrap_or_default(), mime_type: mime_type, size: size.unwrap_or_default(), asset_category: asset_category.unwrap_or_default(), html_tag: html_tag }
    }
...
impl JsArticleMetadata {
    ...
    pub fn new(
        ...
        JsArticleMetadata { published_time: published_time, modified_time: modified_time, author: author, section: section, tags: tags.unwrap_or_default() }
    }
...
impl JsHreflangEntry {
    ...
    pub fn new(lang: Option<String>, url: Option<String>) -> JsHreflangEntry {
        JsHreflangEntry { lang: lang.unwrap_or_default(), url: url.unwrap_or_default() }
    }
...
impl JsFaviconInfo {
    #[wasm_bindgen(constructor)]
    pub fn new(url: Option<String>, rel: Option<String>, sizes: Option<String>, mime_type: Option<String>) -> JsFaviconInfo {
        JsFaviconInfo { url: url.unwrap_or_default(), rel: rel.unwrap_or_default(), sizes: sizes, mime_type: mime_type }
    }
...
impl JsHeadingInfo {
    ...
    pub fn new(level: Option<u8>, text: Option<String>) -> JsHeadingInfo {
        JsHeadingInfo { level: level.unwrap_or_default(), text: text.unwrap_or_default() }
    }
...
impl JsResponseMeta {
    ...
    pub fn new(
        ...
        JsResponseMeta { etag: etag, last_modified: last_modified, cache_control: cache_control, server: server, x_powered_by: x_powered_by, content_language: content_language, content_encoding: content_encoding }
    }
...
impl JsCitationResult {
    ...
    pub fn new(content: Option<String>, references: Option<Vec<JsCitationReference>>) -> JsCitationResult {
        JsCitationResult { content: content.unwrap_or_default(), references: references.unwrap_or_default() }
    }
...
impl JsCitationReference {
    ...
    pub fn new(index: Option<usize>, url: Option<String>, text: Option<String>) -> JsCitationReference {
        JsCitationReference { index: index.unwrap_or_default(), url: url.unwrap_or_default(), text: text.unwrap_or_default() }
    }
...
impl JsBatchScrapeResult {
    ...
    pub fn new(url: Option<String>, result: Option<JsScrapeResult>, error: Option<String>) -> JsBatchScrapeResult {
        JsBatchScrapeResult { url: url.unwrap_or_default(), result: result, error: error }
    }
...
impl JsBatchCrawlResult {
    ...
    pub fn new(url: Option<String>, result: Option<JsCrawlResult>, error: Option<String>) -> JsBatchCrawlResult {
        JsBatchCrawlResult { url: url.unwrap_or_default(), result: result, error: error }
    }
...
pub fn create_engine(config: Option<JsCrawlConfig>) -> Result<JsCrawlEngineHandle, JsValue> {
    ...
    Ok(JsCrawlEngineHandle { inner: Arc::new(result) })
}
...
pub async fn batch_scrape(engine: JsCrawlEngineHandle, urls: Vec<String>) -> Vec<JsBatchScrapeResult> {
    ...
    Ok(Vec<JsBatchScrapeResult>::from(result))
}
...
pub async fn batch_crawl(engine: JsCrawlEngineHandle, urls: Vec<String>) -> Vec<JsBatchCrawlResult> {
    ...
    Ok(Vec<JsBatchCrawlResult>::from(result))
}
...
impl From<JsActionResult> for kreuzcrawl::ActionResult {
    fn from(val: JsActionResult) -> Self {
        Self {
            ...
            action_type: Default::default(),
            success: val.success,
            data: val.data.as_ref().and_then(|v| serde_wasm_bindgen::from_value(v.clone()).ok()),
            error: val.error,
        }
    }
}
...
impl From<JsScrapeResult> for kreuzcrawl::ScrapeResult {
    fn from(val: JsScrapeResult) -> Self {
        Self {
            ...
            extracted_data: val.extracted_data.as_ref().and_then(|v| serde_wasm_bindgen::from_value(v.clone()).ok()),
...
impl From<kreuzcrawl::ScrapeResult> for JsScrapeResult {
    fn from(val: kreuzcrawl::ScrapeResult) -> Self {
        Self {
            ...
            browser_used: val.browser_used,
            markdown: val.markdown.map(Into::into),
            extracted_data: val.extracted_data.as_ref().and_then(|v| serde_wasm_bindgen::to_value(v).ok()),
            extraction_meta: val.extraction_meta.map(Into::into),
            screenshot: val.screenshot.map(|v| v.to_vec()),
            downloaded_document: val.downloaded_document.map(Into::into),
        }
...
impl From<JsMarkdownResult> for kreuzcrawl::MarkdownResult {
    fn from(val: JsMarkdownResult) -> Self {
        Self {
            content: val.content,
            document_structure: val.document_structure.as_ref().and_then(|v| serde_wasm_bindgen::from_value(v.clone()).ok()),
...
impl From<kreuzcrawl::MarkdownResult> for JsMarkdownResult {
    fn from(val: kreuzcrawl::MarkdownResult) -> Self {
        Self {
            content: val.content,
            document_structure: val.document_structure.as_ref().and_then(|v| serde_wasm_bindgen::to_value(v).ok()),
...
impl From<JsAuthConfig> for kreuzcrawl::AuthConfig {
    fn from(val: JsAuthConfig) -> Self {
        match val {
            JsAuthConfig::Basic => Self::Basic { username: Default::default(), password: Default::default() },
            JsAuthConfig::Bearer => Self::Bearer { token: Default::default() },
            JsAuthConfig::Header => Self::Header { name: Default::default(), value: Default::default() },
        }
    }
}
