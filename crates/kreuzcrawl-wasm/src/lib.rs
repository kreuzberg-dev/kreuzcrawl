...
// alef:hash:3e83238a18b6f197296c0a74b34ca573149ded00e70f779c12433b354bbc9fc9
...
impl WasmCrawlEngineHandle {
    ...
    #[allow(clippy::missing_errors_doc)]
    #[wasm_bindgen(js_name = "crawlStream")]
    pub async fn crawl_stream(&self, req: WasmCrawlStreamRequest) -> Result<JsValue, JsValue> {
        ...
        let stream = self
            ...
            .await
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
        let core_chunks: Vec<kreuzcrawl::CrawlEvent> = stream
            .collect::<Vec<_>>()
            .await
            .into_iter()
        ...
        for chunk in core_chunks {
            arr.push(&JsValue::from(WasmCrawlEvent::from(chunk)));
        }
        Ok(arr.into())
    }
    ...
    #[allow(clippy::missing_errors_doc)]
    #[wasm_bindgen(js_name = "batchCrawlStream")]
    pub async fn batch_crawl_stream(&self, req: WasmBatchCrawlStreamRequest) -> Result<JsValue, JsValue> {
        use futures_util::StreamExt;
