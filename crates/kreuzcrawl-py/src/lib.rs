...
// alef:hash:2a68ecd18c7cd05ed851b777f22e0f64a253c1c35907e684bdc916a477a9b8ed
...
impl CrawlEvent {
    ...
    #[getter]
    fn page(&self) -> Option<CrawlPageResult> {
        match &self.inner {
            kreuzcrawl::CrawlEvent::Page(data) => Some((**data).clone().into()),
            _ => None,
        }
    }
