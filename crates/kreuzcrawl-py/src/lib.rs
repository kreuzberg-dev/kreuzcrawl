...
// alef:hash:8024c76862689e6d6fc76c491572824ac0056e5a92f80e0ef816ebe2b3421ccb
...
impl ExtractionMeta {
    ...
    #[must_use]
    #[pyo3(signature = (chunks_processed, cost=None, prompt_tokens=None, completion_tokens=None, model=None))]
    #[new]
    pub fn new(
...
impl ProxyConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url, username=None, password=None))]
    #[new]
...
impl ContentConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (output_format, preprocessing_preset, remove_navigation, remove_forms, strip_tags, preserve_tags, exclude_selectors, skip_images, wrap, wrap_width, include_document_structure, max_depth=None))]
    #[new]
    pub fn new(
...
impl BrowserConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (mode, backend, timeout, wait, stealth, block_url_patterns, capture_network_events, endpoint=None, wait_selector=None, extra_wait=None, proxy=None, eval_script=None, robots_user_agent=None))]
    #[new]
    pub fn new(
        mode: BrowserMode,
...
impl CrawlConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (respect_robots_txt, soft_http_errors, stay_on_domain, allow_subdomains, include_paths, exclude_paths, custom_headers, request_timeout, max_redirects, retry_count, retry_codes, cookies_enabled, remove_tags, content, download_assets, asset_types, browser, user_agents, capture_screenshot, download_documents, document_mime_types, save_browser_profile, max_depth=None, max_pages=None, max_concurrent=None, user_agent=None, rate_limit_ms=None, auth=None, max_body_size=None, map_limit=None, map_search=None, max_asset_size=None, proxy=None, document_max_size=None, warc_output=None, browser_profile=None))]
    #[new]
    pub fn new(
...
impl BrowserExtras {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (network_events, cookies, eval_result=None))]
    #[new]
...
impl DownloadedDocument {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url, mime_type, size, content_hash, headers, filename=None))]
    #[new]
    pub fn new(
        url: String,
        mime_type: String,
...
impl InteractionResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (action_results, final_html, final_url))]
    #[new]
...
impl ActionResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (action_index, action_type, success, data=None, error=None))]
    #[new]
    pub fn new(
        action_index: usize,
        action_type: String,
...
impl ScrapeResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (status_code, final_url, content_type, html, body_size, metadata, links, images, feeds, json_ld, is_allowed, noindex_detected, nofollow_detected, is_pdf, was_skipped, auth_header_sent, assets, js_render_hint, browser_used, crawl_delay=None, x_robots_tag=None, detected_charset=None, response_meta=None, markdown=None, extracted_data=None, extraction_meta=None, downloaded_document=None, browser=None))]
    #[new]
    pub fn new(
        status_code: u16,
        final_url: String,
...
impl CrawlPageResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url, normalized_url, status_code, content_type, html, body_size, metadata, links, images, feeds, json_ld, depth, stayed_on_domain, was_skipped, is_pdf, browser_used, detected_charset=None, markdown=None, extracted_data=None, extraction_meta=None, downloaded_document=None))]
    #[new]
    pub fn new(
        url: String,
...
impl CrawlResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (pages, final_url, redirect_count, was_skipped, cookies, stayed_on_domain, browser_used, error=None))]
    #[new]
    pub fn new(
...
impl SitemapUrl {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url, lastmod=None, changefreq=None, priority=None))]
    #[new]
...
impl MarkdownResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (content, tables, warnings, citations, document_structure=None, fit_content=None))]
    #[new]
    pub fn new(
        content: String,
        tables: Vec<String>,
...
impl LinkInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url, text, link_type, nofollow, rel=None))]
    #[new]
...
impl ImageInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url, source, alt=None, width=None, height=None))]
    #[new]
...
impl FeedInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url, feed_type, title=None))]
    #[new]
...
impl JsonLdEntry {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (schema_type, raw, name=None))]
    #[new]
...
impl DownloadedAsset {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url, content_hash, size, asset_category, mime_type=None, html_tag=None))]
    #[new]
    pub fn new(
        url: String,
        content_hash: String,
...
impl ArticleMetadata {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (tags, published_time=None, modified_time=None, author=None, section=None))]
    #[new]
    pub fn new(
        tags: Vec<String>,
...
impl FaviconInfo {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url, rel, sizes=None, mime_type=None))]
    #[new]
...
impl CitationResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (content, references))]
    #[new]
...
impl BatchScrapeResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url, result=None, error=None))]
    #[new]
...
impl BatchScrapeResults {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (results, total_count, completed_count, failed_count))]
    #[new]
    pub fn new(
