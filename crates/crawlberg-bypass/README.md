...
Configurable HTTP-based `BypassProvider` implementations for [crawlberg](https://github.com/xberg-io/crawlberg), driven by per-vendor YAML configs.
...
```rust
use std::path::Path;
use crawlberg_bypass::{load_with_process_env, SimpleHttpProvider};
