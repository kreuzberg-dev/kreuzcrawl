...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/kreuzcrawl/releases/download/v0.3.0-rc.81/Kreuzcrawl-rs.artifactbundle.zip",
      checksum: "4d2b16433491425bfde9692e599d55c390fa4ca510eca6085abceaf16a104b0c"
    ),
