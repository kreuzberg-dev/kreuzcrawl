...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.0.0/Crawlberg-rs.artifactbundle.zip",
      checksum: "2959c43da27518ca043e52b5dcf71ce9e80244d12a6307406a9940f4ecd1db1f"
    ),
