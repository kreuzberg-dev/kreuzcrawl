...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.0.0-rc.2/Crawlberg-rs.artifactbundle.zip",
      checksum: "3e3302e67df8e3c8102a84a5a5c654db618588f14a51e3b35c5bd1c3faee614e"
    ),
