...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/kreuzcrawl/releases/download/v0.3.0-rc.88/Kreuzcrawl-rs.artifactbundle.zip",
      checksum: "745facd1072b43e655e7421102a448cff1cd23a223aa50442cbabb22437bb5d3"
    ),
