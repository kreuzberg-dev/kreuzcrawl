...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/kreuzcrawl/releases/download/v0.3.0/Kreuzcrawl-rs.artifactbundle.zip",
      checksum: "b93686467fc1d32a81b9039113f46c5007d5d0801ad3fc37c3a9210de1dd057b"
    ),
