...
// alef:hash:6f01a1d902cd9492ce4a74ca139ec99f97379280ea4d23fbc2a0fcdeef19febc
...
class MiddlewareTest {
    ...
    void testMiddlewareNoopNoEffect() throws Exception {
        ...
        assertEquals("Middleware Test", java.util.Optional.ofNullable(result.metadata().title()).orElse("").trim());
    }
