...
// alef:hash:3c7740453c38a78747c94d6b0f0a94773532e847318381b7c8b0a8c013fbe4bb
...
class EngineTest {
    ...
    void testEngineCrawlBasic() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertEquals(3, result.pagesCrawled());        // skipped: field 'crawl.min_pages' not available on result type
    }
