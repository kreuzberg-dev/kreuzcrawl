...
// alef:hash:35a7edb494d205225ee5c2112585b3f39af9885281b83995d138b5cbee4221f4
...
assertEquals(200, result.statusCode());
    ...
    void testRateLimitBasicDelay() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertEquals(3, result.pagesCrawled());        // skipped: field 'rate_limit.min_duration_ms' not available on result type
    }
    ...
    void testRateLimitZeroNoDelay() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertEquals(2, result.pagesCrawled());
    }
