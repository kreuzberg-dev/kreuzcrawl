...
// alef:hash:777f8e57d4b7674daaaa776168725c2d2866dd655b7552031205b2ce2ba82391
...
assertEquals(true, result.wasSkipped());
    ...
    void testCrawlConcurrentDepth() throws Exception {
        ...
        var result = Kreuzcrawl.crawl(engine, url);
assertEquals(3, result.pages().size());        // skipped: field 'stayed_on_domain' not available on result type
    }
...
assertEquals(2, result.pages().size());
    ...
    void testCrawlExternalLinksIgnored() throws Exception {
        ...
        var result = Kreuzcrawl.crawl(engine, url);
assertEquals(2, result.pages().size());        // skipped: field 'stayed_on_domain' not available on result type
    }
