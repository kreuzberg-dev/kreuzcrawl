...
// alef:hash:367cc7f7d6ffac9d5617a521a78b1168b3b98e0b68db5b02d6f99c3c939cb714
...
class RobotsTest {
    ...
    void testRobotsCrawlDelay() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals(2, java.util.Optional.ofNullable(result.crawlDelay()).orElse(""));
    }
    ...
    void testRobotsRequestRate() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals(5, java.util.Optional.ofNullable(result.crawlDelay()).orElse(""));
        assertEquals(true, result.isAllowed());
    }
    ...
    void testRobotsXRobotsTag() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals("noindex, nofollow", java.util.Optional.ofNullable(result.xRobotsTag()).orElse("").trim());
        assertEquals(true, result.noindexDetected());
        assertEquals(true, result.nofollowDetected());
    }
