...
// alef:hash:c99daeccb00fd33b222044b8db4b86acc70528d7f12cce4b418b5439516a2e57
...
class RobotsTest {
    ...
    void testRobotsCrawlDelay() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals(2, result.crawlDelay().orElse(0L));
    }
    ...
    void testRobotsRequestRate() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals(5, result.crawlDelay().orElse(0L));
        assertEquals(true, result.isAllowed());
    }
