...
// alef:hash:5630eed2a6427a34680077e43da8e0435fe12afaa00f48d1cc3af3455ceef22a
...
class ContentTest {
    ...
    void testContentUtf8Bom() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals("utf-8", java.util.Optional.ofNullable(result.detectedCharset()).orElse("").trim());
        assertFalse(result.html().isEmpty(), "expected non-empty value");
    }
