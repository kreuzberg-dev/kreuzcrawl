...
// alef:hash:1b72f93c648d2cd4cdf421f36a021b9cd61a6fe32d703fa98132dd1742d31186
...
class ScrapeTest {
    ...
    void testScrapeBasicHtmlPage() throws Exception {
        ...
        assertFalse(result.metadata().canonicalUrl().isEmpty(), "expected non-empty value");
        ...
        assertTrue(result.metadata().ogTitle().isEmpty(), "expected empty value");
    }
    ...
    void testScrapeDublinCore() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals(200, result.statusCode());
        assertFalse(result.metadata().dcTitle().isEmpty(), "expected non-empty value");
    ...
    void testScrapeOgMetadata() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals(200, result.statusCode());
        assertFalse(result.metadata().ogTitle().isEmpty(), "expected non-empty value");
        ...
        assertFalse(result.metadata().ogDescription().isEmpty(), "expected non-empty value");
    ...
    void testScrapeTwitterCard() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals(200, result.statusCode());
        assertFalse(result.metadata().twitterCard().isEmpty(), "expected non-empty value");
