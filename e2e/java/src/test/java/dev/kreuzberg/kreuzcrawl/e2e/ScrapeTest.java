...
// alef:hash:39a9271efc5e5de2f2149106266a1840c832c994c2a03ac453cfc9a7de351dc7
...
class ScrapeTest {
    ...
    void testScrapeBasicHtmlPage() throws Exception {
        ...
        assertEquals("Example Domain", java.util.Optional.ofNullable(result.metadata().title()).orElse("").trim());
        assertTrue(java.util.Optional.ofNullable(result.metadata().description()).orElse("").contains("illustrative examples"), "expected to contain: " + "illustrative examples");
        assertFalse(java.util.Optional.ofNullable(result.metadata().canonicalUrl()).isEmpty(), "expected non-empty value");
    ...
    void testScrapeDublinCore() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals(200, result.statusCode());
        assertFalse(java.util.Optional.ofNullable(result.metadata().dcTitle()).isEmpty(), "expected non-empty value");
        assertEquals("Effects of Climate Change on Marine Biodiversity", java.util.Optional.ofNullable(result.metadata().dcTitle()).orElse("").trim());
        assertEquals("Dr. Jane Smith", java.util.Optional.ofNullable(result.metadata().dcCreator()).orElse("").trim());
    }
    ...
    void testScrapeImageSources() throws Exception {
        ...
        assertEquals("https://example.com/images/og-hero.jpg", java.util.Optional.ofNullable(result.metadata().ogImage()).orElse("").trim());
    }
    ...
    void testScrapeJsonLd() throws Exception {
        ...
        assertEquals("Best Chocolate Cake", java.util.Optional.ofNullable(result.jsonLd().getFirst().name()).orElse("").trim());
    }
    ...
    void testScrapeMalformedHtml() throws Exception {
        ...
        assertEquals(200, result.statusCode());
        assertFalse(result.html().isEmpty(), "expected non-empty value");
        assertTrue(java.util.Optional.ofNullable(result.metadata().description()).orElse("").contains("broken HTML"), "expected to contain: " + "broken HTML");
    }
    ...
    void testScrapeOgMetadata() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals(200, result.statusCode());
        assertFalse(java.util.Optional.ofNullable(result.metadata().ogTitle()).isEmpty(), "expected non-empty value");
        assertEquals("Article Title", java.util.Optional.ofNullable(result.metadata().ogTitle()).orElse("").trim());
        assertEquals("article", java.util.Optional.ofNullable(result.metadata().ogType()).orElse("").trim());
        assertEquals("https://example.com/images/article-hero.jpg", java.util.Optional.ofNullable(result.metadata().ogImage()).orElse("").trim());
        assertFalse(java.util.Optional.ofNullable(result.metadata().ogDescription()).isEmpty(), "expected non-empty value");
        assertEquals("Article Title - Example Blog", java.util.Optional.ofNullable(result.metadata().title()).orElse("").trim());
    }
    ...
    void testScrapeTwitterCard() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
        assertEquals(200, result.statusCode());
        assertFalse(java.util.Optional.ofNullable(result.metadata().twitterCard()).isEmpty(), "expected non-empty value");
        assertEquals("summary_large_image", java.util.Optional.ofNullable(result.metadata().twitterCard()).orElse("").trim());
        assertEquals("New Product Launch", java.util.Optional.ofNullable(result.metadata().twitterTitle()).orElse("").trim());
    }
