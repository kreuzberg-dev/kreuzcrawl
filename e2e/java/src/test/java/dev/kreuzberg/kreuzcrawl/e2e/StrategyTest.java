...
// alef:hash:0714c76f2bde40b7412d1d57cc09302b144802cf27b86f630533a1ae8fcdceb7
...
assertTrue(result.pagesCrawled() >= 1, "expected >= 1");
    }
    ...
    void testStrategyAdaptiveWindow() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertTrue(result.pagesCrawled() >= 3, "expected >= 3");
    }
    ...
    void testStrategyBestFirstSeed() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertEquals(3, result.pagesCrawled());        // skipped: field 'strategy.first_page_url_contains' not available on result type
    }
    ...
    void testStrategyBfsDefaultOrder() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertEquals(5, result.pagesCrawled());        // skipped: field 'strategy.crawl_order' not available on result type
    }
