...
// alef:hash:4cdd5ae420ceeaa7bed5c1f70547ada04148e9f4b261f3b325e357ec79b04603
...
describe("error", () => {
  ...
  it("error_empty_response: Handles 200 with completely empty body gracefully", async () => {
    ...
    const result = await scrape(engine, url); // skipped: field 'html_not_empty' not available on result type
