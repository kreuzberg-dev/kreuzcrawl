...
// alef:hash:07531a12ab3c0c47323bbc17f3993a6a3ef8d3a088077748490877d84691c9e4
...
async fn test_validation_empty_batch_urls() {
    ...
    assert!(
        result.as_ref().err().unwrap().error_type().contains("urls"),
...
async fn test_validation_invalid_auth_config() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("auth"),
        "error message mismatch"
    );
}
...
async fn test_validation_invalid_exclude_regex() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("exclude_path"),
        "error message mismatch"
    );
}
...
async fn test_validation_invalid_include_regex() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("include_path"),
        "error message mismatch"
    );
}
...
async fn test_validation_invalid_proxy_url() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("proxy"),
        "error message mismatch"
    );
}
...
async fn test_validation_invalid_retry_code() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("retry code"),
        "error message mismatch"
    );
}
...
async fn test_validation_max_concurrent_zero() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("max_concurrent"),
        "error message mismatch"
    );
}
...
async fn test_validation_max_depth_too_high() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("max_depth"),
        "error message mismatch"
    );
}
...
async fn test_validation_max_pages_zero() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("max_pages"),
        "error message mismatch"
    );
}
...
async fn test_validation_max_redirects_too_high() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("max_redirects"),
        "error message mismatch"
    );
}
...
async fn test_validation_negative_body_size() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("body_size"),
        "error message mismatch"
    );
}
...
async fn test_validation_timeout_zero() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("request_timeout"),
        "error message mismatch"
    );
}
