...
async fn test_validation_invalid_exclude_regex() {
    ...
    let engine_config: kreuzcrawl::CrawlConfig = serde_json::from_str("{\"exclude_paths\":[\"(unclosed\"]}").expect("config should parse");
...
async fn test_validation_invalid_include_regex() {
    ...
    let engine_config: kreuzcrawl::CrawlConfig = serde_json::from_str("{\"include_paths\":[\"[invalid\"]}").expect("config should parse");
    let engine = kreuzcrawl::create_engine(Some(engine_config)).expect("handle creation should succeed");
...
async fn test_validation_invalid_retry_code() {
    ...
    let engine_config: kreuzcrawl::CrawlConfig = serde_json::from_str("{\"retry_codes\":[999]}").expect("config should parse");
    let engine = kreuzcrawl::create_engine(Some(engine_config)).expect("handle creation should succeed");
...
async fn test_validation_max_pages_zero() {
    ...
    let engine_config: kreuzcrawl::CrawlConfig = serde_json::from_str("{\"max_pages\":0}").expect("config should parse");
    let engine = kreuzcrawl::create_engine(Some(engine_config)).expect("handle creation should succeed");
...
async fn test_validation_max_redirects_too_high() {
    ...
    let engine_config: kreuzcrawl::CrawlConfig = serde_json::from_str("{\"max_redirects\":200}").expect("config should parse");
    let engine = kreuzcrawl::create_engine(Some(engine_config)).expect("handle creation should succeed");
...
async fn test_validation_timeout_zero() {
    ...
    let engine_config: kreuzcrawl::CrawlConfig = serde_json::from_str("{\"request_timeout\":0}").expect("config should parse");
    let engine = kreuzcrawl::create_engine(Some(engine_config)).expect("handle creation should succeed");
