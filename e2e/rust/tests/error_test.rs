...
// alef:hash:0c55a260631cd8737e2322fdc9880796030fc2ef7add5f3a27ffad6c461a83c2
...
async fn test_error_401_unauthorized() {
    ...
    assert_eq!(result.status_code, 401, "equals assertion failed");
    assert!(result.is_err(), "expected call to fail");
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("unauthorized"),
...
async fn test_error_403_forbidden() {
    ...
    let result = scrape(&engine, &url).await;
    assert_eq!(result.status_code, 403, "equals assertion failed");
    assert!(result.is_err(), "expected call to fail");
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("forbidden"),
        "error message mismatch"
    );
}
...
async fn test_error_404_page() {
    ...
    let result = scrape(&engine, &url).await;
    assert_eq!(result.status_code, 404, "equals assertion failed");
    assert!(result.is_err(), "expected call to fail");
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("not_found"),
        "error message mismatch"
    );
}
...
async fn test_error_408_request_timeout() {
    ...
    let result = scrape(&engine, &url).await;
    assert_eq!(result.status_code, 408, "equals assertion failed");
    assert!(result.is_err(), "expected call to fail");
    assert!(result.is_err(), "expected call to fail");
    assert!(
...
async fn test_error_410_gone() {
    ...
    let result = scrape(&engine, &url).await;
    assert_eq!(result.status_code, 410, "equals assertion failed");
    assert!(result.is_err(), "expected call to fail");
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("gone"),
        "error message mismatch"
    );
}
...
async fn test_error_500_server() {
    ...
    let result = scrape(&engine, &url).await;
    assert_eq!(result.status_code, 500, "equals assertion failed");
    assert!(result.is_err(), "expected call to fail");
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("server_error"),
        "error message mismatch"
    );
}
...
async fn test_error_502_bad_gateway() {
    ...
    let result = scrape(&engine, &url).await;
    assert_eq!(result.status_code, 502, "equals assertion failed");
    assert!(result.is_err(), "expected call to fail");
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("bad_gateway"),
        "error message mismatch"
    );
}
...
async fn test_error_connection_refused() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("connection"),
        "error message mismatch"
    );
}
...
async fn test_error_dns_resolution() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("dns"),
        "error message mismatch"
    );
}
...
async fn test_error_partial_response() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("data_loss"),
        "error message mismatch"
    );
}
...
async fn test_error_rate_limited() {
    ...
    let result = scrape(&engine, &url).await;
    assert_eq!(result.status_code, 429, "equals assertion failed");
    assert!(result.is_err(), "expected call to fail");
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("rate_limited"),
        "error message mismatch"
    );
}
...
async fn test_error_ssl_invalid_cert() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().error_type().contains("ssl"),
        "error message mismatch"
    );
}
