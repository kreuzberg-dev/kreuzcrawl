...
// alef:hash:b4897e79e7a851bef52db0a56b92dee7f209960b6d3596d18492959f53eff143
...
test "strategy_adaptive_saturation" {
    ...
    try testing.expect(result.object.get("crawl").?.object.get("pages_crawled").?.integer >= 1);
}
...
test "strategy_adaptive_window" {
    ...
    defer _parsed.deinit();
    const result = &_parsed.value;
    try testing.expect(result.object.get("crawl").?.object.get("pages_crawled").?.integer >= 3);
}
...
test "strategy_best_first_seed" {
    ...
    defer _parsed.deinit();
    const result = &_parsed.value;
    try testing.expectEqual(3, result.object.get("crawl").?.object.get("pages_crawled").?.integer);
...
test "strategy_bfs_default_order" {
    ...
    defer _parsed.deinit();
    const result = &_parsed.value;
    try testing.expectEqual(5, result.object.get("crawl").?.object.get("pages_crawled").?.integer);
