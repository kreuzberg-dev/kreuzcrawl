...
// alef:hash:4f6ad72815b104dff7ed8ceeb866583b4c5a3190620b861a62c10bbc0a39d35b
...
test "filter_bm25_empty_query" {
    ...
    try testing.expectEqual(2, result.object.get("crawl").?.object.get("pages_crawled").?.integer);
}
