...
// alef:hash:04db81de1dc7d5144329b73798aa27fa3cf074a4f713fe27d0949271bec58eff
...
namespace Kreuzcrawl
{
    ...
    public class StreamTests
    {
        ...
        public async Task Test_BatchCrawlStreamEvents()
        {
            ...
            var urls = new System.Collections.Generic.List<string>(new string[] { "__BASE__/page1", "__BASE__/page2", "__BASE__/page3" }.Select(p => p.StartsWith("http") ? p : _base_urls + p));
        ...
        public async Task Test_BatchCrawlStreamPartialFailure()
        {
            ...
            var urls = new System.Collections.Generic.List<string>(new string[] { "__BASE__/success1", "__BASE__/fail", "__BASE__/success2" }.Select(p => p.StartsWith("http") ? p : _base_urls + p));
            var urlsReq = new BatchCrawlStreamRequest { Urls = urls };
            await foreach (var item in engine.BatchCrawlStreamAsync(urlsReq))
            {
                // Stream items are consumed but assertions are skipped for streaming tests
