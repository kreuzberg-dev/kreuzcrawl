...
// alef:hash:194685a76a39c5d401d03a270a94af75c225a6351a31300ce68ba28817da82d5
...
namespace Kreuzcrawl
{
    ...
    Assert.False(result.BrowserUsed);
        ...
        public async Task Test_BrowserCrawlModeAlways()
        {
            ...
            var result = await KreuzcrawlLib.Scrape(engine, url);
            // skipped: field 'pages.length' not available on result typeAssert.True(result.BrowserUsed);
    ...
    Assert.False(result.BrowserUsed);
        ...
        public async Task Test_BrowserDetectNextRendered()
        {
            ...
            var result = await KreuzcrawlLib.Scrape(engine, url);
    Assert.True(result.StatusCode == 200);
            // skipped: field 'html_not_empty' not available on result typeAssert.False(result.JsRenderHint);
    Assert.False(result.BrowserUsed);
    ...
    Assert.False(result.BrowserUsed);
        ...
        public async Task Test_BrowserDetectReactShell()
        {
            ...
            var result = await KreuzcrawlLib.Scrape(engine, url);
    Assert.True(result.StatusCode == 200);
            // skipped: field 'html_not_empty' not available on result typeAssert.True(result.JsRenderHint);
    Assert.False(result.BrowserUsed);
