...
public class ValidationTests
{
    ...
    public async Task Test_ValidationInvalidExcludeRegex()
    {
        ...
        var engineConfig = JsonSerializer.Deserialize<CrawlConfig>("{\"exclude_paths\":[\"(unclosed\"]}")!;
    ...
    public async Task Test_ValidationInvalidIncludeRegex()
    {
        ...
        var engineConfig = JsonSerializer.Deserialize<CrawlConfig>("{\"include_paths\":[\"[invalid\"]}")!;
        var engine = KreuzcrawlLib.CreateEngine(engineConfig);
    ...
    public async Task Test_ValidationInvalidRetryCode()
    {
        ...
        var engineConfig = JsonSerializer.Deserialize<CrawlConfig>("{\"retry_codes\":[999]}")!;
        var engine = KreuzcrawlLib.CreateEngine(engineConfig);
    ...
    public async Task Test_ValidationMaxPagesZero()
    {
        ...
        var engineConfig = JsonSerializer.Deserialize<CrawlConfig>("{\"max_pages\":0}")!;
        var engine = KreuzcrawlLib.CreateEngine(engineConfig);
    ...
    public async Task Test_ValidationMaxRedirectsTooHigh()
    {
        ...
        var engineConfig = JsonSerializer.Deserialize<CrawlConfig>("{\"max_redirects\":200}")!;
        var engine = KreuzcrawlLib.CreateEngine(engineConfig);
    ...
    public async Task Test_ValidationTimeoutZero()
    {
        ...
        var engineConfig = JsonSerializer.Deserialize<CrawlConfig>("{\"request_timeout\":0}")!;
        var engine = KreuzcrawlLib.CreateEngine(engineConfig);
