...
# alef:hash:369842ca309feefc23a04b7011d81a98a78f4dc48a7259ac8181d11bd5a01c6f
...
test_browser_config_auto_no_feature() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_CONFIG_AUTO_NO_FEATURE:-${MOCK_SERVER_URL}/fixtures/browser_config_auto_no_feature}" --format json --browser-mode never)
...
test_browser_config_never_mode() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_CONFIG_NEVER_MODE:-${MOCK_SERVER_URL}/fixtures/browser_config_never_mode}" --format json --browser-mode never)
...
test_browser_crawl_mode_always() {
  ...
  kreuzcrawl scrape "${MOCK_SERVER_BROWSER_CRAWL_MODE_ALWAYS:-${MOCK_SERVER_URL}/fixtures/browser_crawl_mode_always}" --format json --browser-mode never >/dev/null
...
test_browser_crawl_waf_fallback() {
  ...
  kreuzcrawl scrape "${MOCK_SERVER_BROWSER_CRAWL_WAF_FALLBACK:-${MOCK_SERVER_URL}/fixtures/browser_crawl_waf_fallback}" --format json --browser-mode never >/dev/null
...
test_browser_detect_minimal_page() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_DETECT_MINIMAL_PAGE:-${MOCK_SERVER_URL}/fixtures/browser_detect_minimal_page}" --format json --browser-mode never)
...
test_browser_detect_next_empty() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_DETECT_NEXT_EMPTY:-${MOCK_SERVER_URL}/fixtures/browser_detect_next_empty}" --format json --browser-mode never)
...
test_browser_detect_next_rendered() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_DETECT_NEXT_RENDERED:-${MOCK_SERVER_URL}/fixtures/browser_detect_next_rendered}" --format json --browser-mode never)
...
test_browser_detect_normal_page() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_DETECT_NORMAL_PAGE:-${MOCK_SERVER_URL}/fixtures/browser_detect_normal_page}" --format json --browser-mode never)
...
test_browser_detect_nuxt_shell() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_DETECT_NUXT_SHELL:-${MOCK_SERVER_URL}/fixtures/browser_detect_nuxt_shell}" --format json --browser-mode never)
...
test_browser_detect_react_shell() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_DETECT_REACT_SHELL:-${MOCK_SERVER_URL}/fixtures/browser_detect_react_shell}" --format json --browser-mode never)
...
test_browser_detect_vue_shell() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_DETECT_VUE_SHELL:-${MOCK_SERVER_URL}/fixtures/browser_detect_vue_shell}" --format json --browser-mode never)
...
test_browser_extra_wait() {
  ...
  kreuzcrawl scrape "${MOCK_SERVER_BROWSER_EXTRA_WAIT:-${MOCK_SERVER_URL}/fixtures/browser_extra_wait}" --format json --browser-mode never >/dev/null
...
test_browser_fallback_spa_render() {
  ...
  kreuzcrawl scrape "${MOCK_SERVER_BROWSER_FALLBACK_SPA_RENDER:-${MOCK_SERVER_URL}/fixtures/browser_fallback_spa_render}" --format json --browser-mode never >/dev/null
...
test_browser_fallback_waf_blocked() {
  ...
  kreuzcrawl scrape "${MOCK_SERVER_BROWSER_FALLBACK_WAF_BLOCKED:-${MOCK_SERVER_URL}/fixtures/browser_fallback_waf_blocked}" --format json --browser-mode never >/dev/null
...
test_browser_mode_always() {
  ...
  kreuzcrawl scrape "${MOCK_SERVER_BROWSER_MODE_ALWAYS:-${MOCK_SERVER_URL}/fixtures/browser_mode_always}" --format json --browser-mode never >/dev/null
...
test_browser_profile_basic() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_PROFILE_BASIC:-${MOCK_SERVER_URL}/fixtures/browser_profile_basic}" --format json --browser-mode never)
...
test_browser_wait_fixed() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_WAIT_FIXED:-${MOCK_SERVER_URL}/fixtures/browser_wait_fixed}" --format json --browser-mode never)
...
test_browser_wait_selector() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_BROWSER_WAIT_SELECTOR:-${MOCK_SERVER_URL}/fixtures/browser_wait_selector}" --format json --browser-mode never)
