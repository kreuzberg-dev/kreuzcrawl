...
# alef:hash:67e99256f671067f7cf2fe8afd5b965e2ecf46279d9bcb8c3f5ac931bbd7493b
...
test_robots_allow_all() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_ALLOW_ALL:-${MOCK_SERVER_URL}/fixtures/robots_allow_all}" --format json --browser-mode never)
...
test_robots_allow_override() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_ALLOW_OVERRIDE:-${MOCK_SERVER_URL}/fixtures/robots_allow_override}" --format json --browser-mode never)
...
test_robots_comments_handling() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_COMMENTS_HANDLING:-${MOCK_SERVER_URL}/fixtures/robots_comments_handling}" --format json --browser-mode never)
...
test_robots_crawl_delay() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_CRAWL_DELAY:-${MOCK_SERVER_URL}/fixtures/robots_crawl_delay}" --format json --browser-mode never)
...
test_robots_disallow_path() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_DISALLOW_PATH:-${MOCK_SERVER_URL}/fixtures/robots_disallow_path}" --format json --browser-mode never)
...
test_robots_meta_nofollow() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_META_NOFOLLOW:-${MOCK_SERVER_URL}/fixtures/robots_meta_nofollow}" --format json --browser-mode never)
...
test_robots_meta_noindex() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_META_NOINDEX:-${MOCK_SERVER_URL}/fixtures/robots_meta_noindex}" --format json --browser-mode never)
...
test_robots_missing_404() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_MISSING_404:-${MOCK_SERVER_URL}/fixtures/robots_missing_404}" --format json --browser-mode never)
...
test_robots_multiple_user_agents() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_MULTIPLE_USER_AGENTS:-${MOCK_SERVER_URL}/fixtures/robots_multiple_user_agents}" --format json --browser-mode never)
...
test_robots_request_rate() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_REQUEST_RATE:-${MOCK_SERVER_URL}/fixtures/robots_request_rate}" --format json --browser-mode never)
...
test_robots_sitemap_directive() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_SITEMAP_DIRECTIVE:-${MOCK_SERVER_URL}/fixtures/robots_sitemap_directive}" --format json --browser-mode never)
...
test_robots_user_agent_specific() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_USER_AGENT_SPECIFIC:-${MOCK_SERVER_URL}/fixtures/robots_user_agent_specific}" --format json --browser-mode never)
...
test_robots_wildcard_paths() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_WILDCARD_PATHS:-${MOCK_SERVER_URL}/fixtures/robots_wildcard_paths}" --format json --browser-mode never)
...
test_robots_x_robots_tag() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ROBOTS_X_ROBOTS_TAG:-${MOCK_SERVER_URL}/fixtures/robots_x_robots_tag}" --format json --browser-mode never)
