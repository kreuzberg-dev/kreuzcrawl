...
# alef:hash:8aed2fc465cd2744dd840eafa5720ee8699e13b32c3662424e3142e93a91d9f5
...
test_links_anchor_fragment() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_LINKS_ANCHOR_FRAGMENT:-${MOCK_SERVER_URL}/fixtures/links_anchor_fragment}" --format json --browser-mode never)
...
test_links_base_tag() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_LINKS_BASE_TAG:-${MOCK_SERVER_URL}/fixtures/links_base_tag}" --format json --browser-mode never)
...
test_links_document_types() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_LINKS_DOCUMENT_TYPES:-${MOCK_SERVER_URL}/fixtures/links_document_types}" --format json --browser-mode never)
...
test_links_empty_href() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_LINKS_EMPTY_HREF:-${MOCK_SERVER_URL}/fixtures/links_empty_href}" --format json --browser-mode never)
...
test_links_internal_external_classification() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_LINKS_INTERNAL_EXTERNAL_CLASSIFICATION:-${MOCK_SERVER_URL}/fixtures/links_internal_external_classification}" --format json --browser-mode never)
...
test_links_mailto_javascript_skip() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_LINKS_MAILTO_JAVASCRIPT_SKIP:-${MOCK_SERVER_URL}/fixtures/links_mailto_javascript_skip}" --format json --browser-mode never)
...
test_links_protocol_relative() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_LINKS_PROTOCOL_RELATIVE:-${MOCK_SERVER_URL}/fixtures/links_protocol_relative}" --format json --browser-mode never)
...
test_links_rel_attributes() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_LINKS_REL_ATTRIBUTES:-${MOCK_SERVER_URL}/fixtures/links_rel_attributes}" --format json --browser-mode never)
...
test_links_relative_parent() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_LINKS_RELATIVE_PARENT:-${MOCK_SERVER_URL}/fixtures/links_relative_parent}" --format json --browser-mode never)
