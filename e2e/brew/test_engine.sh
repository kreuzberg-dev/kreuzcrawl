...
# alef:hash:e8dcb7e72b7bcfe74cc3c0e8f109fee30221aca568ce32b0656d03dd747da6d6
...
test_engine_crawl_basic() {
  ...
  kreuzcrawl scrape "${MOCK_SERVER_ENGINE_CRAWL_BASIC:-${MOCK_SERVER_URL}/fixtures/engine_crawl_basic}" --format json --browser-mode never >/dev/null
...
test_engine_map_basic() {
  ...
  kreuzcrawl scrape "${MOCK_SERVER_ENGINE_MAP_BASIC:-${MOCK_SERVER_URL}/fixtures/engine_map_basic}" --format json --browser-mode never >/dev/null
...
test_engine_scrape_basic() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ENGINE_SCRAPE_BASIC:-${MOCK_SERVER_URL}/fixtures/engine_scrape_basic}" --format json --browser-mode never)
...
test_engine_stream_basic() {
  ...
  kreuzcrawl scrape "${MOCK_SERVER_ENGINE_STREAM_BASIC:-${MOCK_SERVER_URL}/fixtures/engine_stream_basic}" --format json --browser-mode never >/dev/null
