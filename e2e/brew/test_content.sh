...
# alef:hash:39a477b57b9d8581e7ddec021432a55afe92e683f89aa7147389fb4ffaa5d9fb
...
test_content_204_no_content() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_CONTENT_204_NO_CONTENT:-${MOCK_SERVER_URL}/fixtures/content_204_no_content}" --format json --browser-mode never)
...
test_content_charset_iso8859() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_CONTENT_CHARSET_ISO8859:-${MOCK_SERVER_URL}/fixtures/content_charset_iso8859}" --format json --browser-mode never)
...
test_content_empty_body() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_CONTENT_EMPTY_BODY:-${MOCK_SERVER_URL}/fixtures/content_empty_body}" --format json --browser-mode never)
...
test_content_gzip_compressed() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_CONTENT_GZIP_COMPRESSED:-${MOCK_SERVER_URL}/fixtures/content_gzip_compressed}" --format json --browser-mode never)
...
test_content_large_page_limit() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_CONTENT_LARGE_PAGE_LIMIT:-${MOCK_SERVER_URL}/fixtures/content_large_page_limit}" --format json --browser-mode never)
...
test_content_main_only() {
  ...
  kreuzcrawl scrape "${MOCK_SERVER_CONTENT_MAIN_ONLY:-${MOCK_SERVER_URL}/fixtures/content_main_only}" --format json --browser-mode never >/dev/null
...
test_content_pdf_no_extension() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_CONTENT_PDF_NO_EXTENSION:-${MOCK_SERVER_URL}/fixtures/content_pdf_no_extension}" --format json --browser-mode never)
...
test_content_remove_tags() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_CONTENT_REMOVE_TAGS:-${MOCK_SERVER_URL}/fixtures/content_remove_tags}" --format json --browser-mode never)
...
test_content_utf8_bom() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_CONTENT_UTF8_BOM:-${MOCK_SERVER_URL}/fixtures/content_utf8_bom}" --format json --browser-mode never)
