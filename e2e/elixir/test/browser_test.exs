...
# alef:hash:8a7d58c8ab6722c80b5b1c45ad798209537847bca30108255b7fde0929df3976
...
defmodule E2e.BrowserTest do
  ...
  describe "browser_config_auto_no_feature" do
    test "browser_config_auto_no_feature" do
      ...
      assert to_string(result.js_render_hint) == true
      assert to_string(result.browser_used) == false
    end
  end
  ...
  describe "browser_crawl_mode_always" do
    test "browser_crawl_mode_always" do
      ...
      assert to_string(result.browser_used) == true
    end
  end
  ...
  describe "browser_detect_minimal_page" do
    test "browser_detect_minimal_page" do
      ...
      {:ok, result} = Kreuzcrawl.scrape_async(engine, url)
      assert result.status_code == 200
      assert to_string(result.js_render_hint) == false
      assert to_string(result.browser_used) == false
    end
  end
