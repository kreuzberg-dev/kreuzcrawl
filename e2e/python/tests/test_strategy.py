...
# alef:hash:c64d7a4479c9fa2a059e6c03fdff54226dd22e0e9b2fa2a4f3c906c9ef4fa6e8
...
async def test_strategy_adaptive_saturation() -> None:
    ...
    assert result.pages_crawled >= 1  # noqa: S101
...
async def test_strategy_adaptive_window() -> None:
    ...
    result = await scrape(engine, url)
    assert result.pages_crawled >= 3  # noqa: S101
...
async def test_strategy_bfs_default_order() -> None:
    ...
    result = await scrape(engine, url)
    assert result.pages_crawled == 5  # noqa: S101
