...
# alef:hash:8729cb80746e6d273e6cbe163ce52365f95c9cd54873883988aed50b630bce45
...
async def test_batch_crawl_stream_events() -> None:
    ...
    urls = [
        ...
        for p in ["__BASE__/page1", "__BASE__/page2", "__BASE__/page3"]
    ]
...
async def test_batch_crawl_stream_partial_failure() -> None:
    ...
    urls = [
        p if p.startswith("http") else f"{urls_base}{p}"
        for p in ["__BASE__/success1", "__BASE__/fail", "__BASE__/success2"]
    ]
