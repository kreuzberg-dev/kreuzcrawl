...
// alef:hash:7996d1cf73dae86b30ea3adb4c4847110028aa8830eb5c30e5fc1887913c0807
...
final class ScrapeTest extends TestCase
{
    ...
    public function test_scrape_asset_dedup(): void
    {
        ...
        $this->assertEquals(2, trim(count($result->assets)));
    ...
    public function test_scrape_asset_type_filter(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(200, trim($result->status_code));
        $this->assertEquals(1, trim(count($result->assets)));
    ...
    public function test_scrape_basic_html_page(): void
    {
        ...
        $this->assertEquals(0, trim(count($result->images)));
        $this->assertEmpty(trim($result->metadata->og_title));
    }
