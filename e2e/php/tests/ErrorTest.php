...
// alef:hash:370dc0a8abc0e148c575c9c3eb22fadb1c848f1598dd196b195762631d22c819
...
final class ErrorTest extends TestCase
{
    ...
    {        $this->expectException(\Exception::class);        $engine_config = CrawlConfig::from_json(json_encode(["request_timeout" => 500]));
        $engine = Kreuzcrawl::createEngine($engine_config);
