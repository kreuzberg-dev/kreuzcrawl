...
// alef:hash:01606f031a20f921a81a86ee47db5361f1634cc6b9f21e0cc958b18d0860e570
...
final class ErrorTest extends TestCase
{
    ...
    {
        $engine_config = CrawlConfig::from_json(json_encode(["request_timeout" => 5000, "respect_robots_txt" => false]));
    ...
    {
        $engine_config = CrawlConfig::from_json(json_encode(["proxy" => ["url" => "http://127.0.0.1:1"], "request_timeout" => 2000]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {
        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => false, "retry_codes" => [503], "retry_count" => 2]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {
        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => false, "retry_codes" => [429], "retry_count" => 3]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {
        $engine_config = CrawlConfig::from_json(json_encode(["request_timeout" => 1]));
        $engine = Kreuzcrawl::createEngine($engine_config);
