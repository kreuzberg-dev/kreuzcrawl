...
// alef:hash:3fb30950f084e7f83d15d2388c1302f8d7cc45cebaf1cfe6e8828f18d664afb2
...
final class MarkdownTest extends TestCase
{
    ...
    public function test_markdown_basic_conversion(): void
    {
        ...
        $this->assertNotEmpty($result->getMarkdown()->getContent());
        $this->assertStringContainsString("Hello World", $result->getMarkdown()->getContent());
    ...
    public function test_markdown_headings_and_paragraphs(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertNotEmpty($result->getMarkdown()->getContent());
        $this->assertStringContainsString("Main Title", $result->getMarkdown()->getContent());
    ...
    public function test_markdown_links_converted(): void
    {
        ...
        $this->assertNotEmpty($result->html);
        $this->assertNotEmpty($result->getMarkdown()->getContent());
        $this->assertStringContainsString("Example", $result->getMarkdown()->getContent());
