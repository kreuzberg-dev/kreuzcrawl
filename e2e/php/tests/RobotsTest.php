...
// alef:hash:68193c9a196efe8a37576625146f9c3f4f18a168f9d8bc6c8e1f35d1e75ff24a
...
final class RobotsTest extends TestCase
{
    ...
    public function test_robots_allow_all(): void
    {
        ...
        $this->assertEquals(true, trim($result->is_allowed));
    }
    ...
    public function test_robots_crawl_delay(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(2, trim($result->crawl_delay));
    }
    ...
    public function test_robots_disallow_path(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(false, trim($result->is_allowed));
    }
    ...
    public function test_robots_meta_nofollow(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(true, trim($result->nofollow_detected));
    }
    ...
    public function test_robots_meta_noindex(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(true, trim($result->noindex_detected));
    }
    ...
    public function test_robots_request_rate(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(5, trim($result->crawl_delay));
        $this->assertEquals(true, trim($result->is_allowed));
    }
