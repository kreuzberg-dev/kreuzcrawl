...
// alef:hash:fdd991ad5a0889043f9f3d7f4ab2f20eb41c1cf6b109d8a2350c64bc9c2e318d
...
final class StreamTest extends TestCase
{
    ...
    public function test_batch_crawl_stream_events(): void
    {
        ...
        $urls = array_map(fn ($p) => str_starts_with($p, 'http') ? $p : $urls_base . $p, ["__BASE__/page1", "__BASE__/page2", "__BASE__/page3"]);
    ...
    public function test_batch_crawl_stream_partial_failure(): void
    {
        ...
        $urls = array_map(fn ($p) => str_starts_with($p, 'http') ? $p : $urls_base . $p, ["__BASE__/success1", "__BASE__/fail", "__BASE__/success2"]);
        $result = Kreuzcrawl::batchCrawlStream($engine, $urls);
        $__camel = function ($v) use (&$__camel) {
            if (is_array($v)) {
                $out = [];
