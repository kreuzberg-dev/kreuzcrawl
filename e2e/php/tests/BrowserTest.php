...
// alef:hash:fbacc3ed4f3e741217f2e76c5c3bb1cf947549b0a716685b4b3785e7bc503745
...
final class BrowserTest extends TestCase
{
    ...
    public function test_browser_crawl_mode_always(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        // skipped: field 'pages.length' not available on result type            $this->assertEquals(true, $result->browserUsed);
    ...
    public function test_browser_detect_next_rendered(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(200, $result->statusCode);
        // skipped: field 'html_not_empty' not available on result type            $this->assertEquals(false, $result->jsRenderHint);
        $this->assertEquals(false, $result->browserUsed);
    ...
    public function test_browser_detect_react_shell(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(200, $result->statusCode);
        // skipped: field 'html_not_empty' not available on result type            $this->assertEquals(true, $result->jsRenderHint);
        $this->assertEquals(false, $result->browserUsed);
