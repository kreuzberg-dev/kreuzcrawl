...
// alef:hash:09dbdcda56d4f29b2e6033ad73efdd96af2666d1bb15551a433ef65cea4dfdd2
...
final class ValidationTest extends TestCase
{
    ...
    {        $this->expectException(\Exception::class);        $engine_config = CrawlConfig::from_json(json_encode(["exclude_paths" => ["(unclosed"]]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $this->expectException(\Exception::class);        $engine_config = CrawlConfig::from_json(json_encode(["include_paths" => ["[invalid"]]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $this->expectException(\Exception::class);        $engine_config = CrawlConfig::from_json(json_encode(["retry_codes" => [999]]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $this->expectException(\Exception::class);        $engine_config = CrawlConfig::from_json(json_encode(["max_concurrent" => 0]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $this->expectException(\Exception::class);        $engine_config = CrawlConfig::from_json(json_encode(["max_depth" => 200]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $this->expectException(\Exception::class);        $engine_config = CrawlConfig::from_json(json_encode(["max_pages" => 0]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $this->expectException(\Exception::class);        $engine_config = CrawlConfig::from_json(json_encode(["max_redirects" => 200]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $this->expectException(\Exception::class);        $engine_config = CrawlConfig::from_json(json_encode(["max_body_size" => 0]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $this->expectException(\Exception::class);        $engine_config = CrawlConfig::from_json(json_encode(["request_timeout" => 0]));
        $engine = Kreuzcrawl::createEngine($engine_config);
