...
// alef:hash:c1185e96dea8855ae48d189500d87dfe30bcbf78ef965f5344e91177cc9f4df9
...
final class ContentTest extends TestCase
{
    ...
    public function test_content_204_no_content(): void
    {
        ...
        $this->assertEquals(204, trim($result->status_code));
        $this->assertEmpty(trim($result->html));
    }
    ...
    public function test_content_pdf_no_extension(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(true, trim($result->is_pdf));
    }
