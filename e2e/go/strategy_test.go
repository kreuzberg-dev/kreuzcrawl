...
// alef:hash:8faf525acc5cf267de7c790526251c0bfb178d1f82261d507486ac681a7f3d71
...
func Test_StrategyAdaptiveSaturation(t *testing.T) {
	...
	if result.PagesCrawled < 1 {
		t.Errorf("expected >= 1, got %v", result.PagesCrawled)
	}
}
...
func Test_StrategyAdaptiveWindow(t *testing.T) {
	...
	if result.PagesCrawled < 3 {
		t.Errorf("expected >= 3, got %v", result.PagesCrawled)
	}
}
...
func Test_StrategyBestFirstSeed(t *testing.T) {
	...
	if result.PagesCrawled != 3 {
		t.Errorf("equals mismatch: got %v", result.PagesCrawled)
	}
